...
module.exports = (async () => {
    ...
    } = require('@theia/core/lib/electron-browser/messaging/electron-messaging-frontend-module');
    ...
    try {
        ...
        await load(
            container,
            require('@theia/core/lib/electron-browser/menu/electron-menu-module')
        );
        await load(
            container,
            require('@theia/core/lib/electron-browser/window/electron-window-module')
        );
        await load(
            container,
            require('@theia/core/lib/electron-browser/keyboard/electron-keyboard-module')
        );
        await load(
            container,
            require('@theia/core/lib/electron-browser/token/electron-token-frontend-module')
        );
        await load(
            container,
            require('@theia/core/lib/electron-browser/request/electron-browser-request-module')
        );
        await load(
            container,
        ...
        await load(
            container,
            require('@theia/filesystem/lib/electron-browser/file-dialog/electron-file-dialog-module')
        );
        ...
        await load(
            container,
            require('@theia/navigator/lib/electron-browser/electron-navigator-module')
        );
