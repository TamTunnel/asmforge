...
module.exports = (async () => {
    ...
    try {
        ...
        await load(
            container,
            import('@theia/variable-resolver/lib/browser/variable-resolver-frontend-module')
        );
        ...
        await load(
            container,
            import('@theia/filesystem/lib/browser/download/file-download-frontend-module')
        );
        await load(
            container,
            import('@theia/filesystem/lib/browser/file-dialog/file-dialog-module')
        );
        ...
        await load(
            container,
            import('@theia/outline-view/lib/browser/outline-view-frontend-module')
        );
        ...
        await load(
            container,
            import('@theia/userstorage/lib/browser/user-storage-frontend-module')
        );
        ...
        await load(
            container,
            import('@theia/search-in-workspace/lib/browser/search-in-workspace-frontend-module')
        );
        ...
        await load(
            container,
            import('@theia/callhierarchy/lib/browser/callhierarchy-frontend-module')
        );
        ...
        await load(
            container,
            import('@theia/editor-preview/lib/browser/editor-preview-frontend-module')
        );
        ...
        await load(
            container,
            import('@asmforge/assembly-language-support/lib/browser/assembly-language-support-frontend-module')
        );
        await load(container, import('@asmforge/ai-agent/lib/browser/nova-ai-frontend-module'));
        await load(
            container,
            import('@asmforge/register-viewer/lib/browser/register-frontend-module')
        );
        await load(container, import('@asmforge/memory-viewer/lib/browser/memory-frontend-module'));
        await load(container, import('@asmforge/toolchain/lib/browser/toolchain-frontend-module'));
