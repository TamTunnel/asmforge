...
module.exports = (async () => {
    ...
    try {
        ...
        await load(container, require('@asmforge/assembly-language-support/lib/browser/assembly-language-support-frontend-module'));
        await load(container, require('@asmforge/ai-agent/lib/browser/nova-ai-frontend-module'));
        await load(container, require('@asmforge/register-viewer/lib/browser/register-frontend-module'));
        await load(container, require('@asmforge/memory-viewer/lib/browser/memory-frontend-module'));
